 ...
 * @author lyhoa
 */
public class Xem_Thong_Tin_KK extends javax.swing.JFrame {

    /**
     * Creates new form Xem_Thong_Tin_KK
     */
    String makiemke;
    String maphong;
    public Xem_Thong_Tin_KK(String makkchuaduyet) {
        initComponents();
        loadphong();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(button_XacNhanThongtinKiemKe, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void label_TroVeTrangChuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_label_TroVeTrangChuMouseClicked
        ...
        Xem_Thong_Tin_KK.this.setVisible(false);
...
if (JOptionPane.showConfirmDialog(this, "Thoát phần mềm?", "Xác nhận", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Xem_Thong_Tin_KK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Xem_Thong_Tin_KK().setVisible(true);
            }
        });
    }

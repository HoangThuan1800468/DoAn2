 ...
 * @author lyhoa
 */
public class Thong_Tin_Phong extends javax.swing.JFrame {

    /**
     * Creates new form Thong_Tin_Phong
     */
    public Thong_Tin_Phong(String maphonghoc) {
        initComponents();
        thongtinphong(maphonghoc);
    }

    private Thong_Tin_Phong() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    public void thongtinphong(String maphonghoc){
        try{
        Connect a = new Connect();
        Connection conn = a.getConnection();
         if (conn!=null){
             Statement dd = conn.createStatement();  
             ResultSet  kq = dd.executeQuery("select * from phonghoc where maphong = '"+maphonghoc+"'");
             while(kq.next()){
                    String tenphong= kq.getString(1);
                    String maphong = kq.getString(2);
                    String tinhtrangphong=kq.getString(3);
                    String dientich=kq.getString(4);
    ...
    private void initComponents() {
        ...
        txt_SoLuongHocSinh.setEnabled(false);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_TenPhong, javax.swing.GroupLayout.DEFAULT_SIZE, 279, Short.MAX_VALUE)
    ...
    private void label_TroVeTrangChuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_label_TroVeTrangChuMouseClicked
        ...
        Thong_Tin_Phong.this.setVisible(false);
...
if (JOptionPane.showConfirmDialog(this, "Thoát phần mềm?", "Xác nhận", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Thong_Tin_Phong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_Tin_Phong().setVisible(true);
            }
        });
    }
